...
public class Blue extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.blueFacebook).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://www.facebook.com/Blue-Medellin-145792858776714/"));
                startActivity(intent);
            }
        });
        view.findViewById(R.id.blueYoutube).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://www.youtube.com/watch?v=EuroEFPmQUw"));
                startActivity(intent);
            }
        });
    }
