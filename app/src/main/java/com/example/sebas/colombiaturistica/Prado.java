...
public class Prado extends Fragment {
    static final LatLng PradoPos = new LatLng(6.2546883,-75.5628707);
    MapView mMapView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_prado, container, false);
        ...
        MarkerOptions marker = new MarkerOptions().position(PradoPos).title("Barrio Prado");
        // adding marker
        googleMap.addMarker(marker.title("Barrio Prado").snippet("Barrio Prado"));
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(PradoPos).zoom(15).build();
