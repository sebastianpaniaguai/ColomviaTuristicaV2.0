...
public class Tibiri extends Fragment {
    static final LatLng TibiriPos = new LatLng(6.2502739,-75.5908904);
    MapView mMapView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_tibiri, container, false);
        ...
        MarkerOptions marker = new MarkerOptions().position(TibiriPos).title("El Tibiri");
        // adding marker
        googleMap.addMarker(marker.title("Club Tibiri").snippet("Tibiri Tabara"));
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(TibiriPos).zoom(15).build();
